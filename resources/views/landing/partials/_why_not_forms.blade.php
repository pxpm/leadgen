    ...
    <div class="max-w-5xl mx-auto">
        <div class="text-center max-w-2xl mx-auto">
            <h2 class="text-3xl sm:text-4xl font-bold tracking-tight text-gray-900 leading-tight">
                {{ __('landing.why_not_forms.headline') }}
            </h2>
        </div>

        <div class="mt-14 grid md:grid-cols-2 rounded-3xl overflow-hidden border border-gray-200">
            <div class="bg-gray-50/80 p-8 md:p-10 relative">
                ...
                <div class="mt-14">
                    <h3 class="text-xl font-bold text-gray-400 mb-6">{{ __('landing.why_not_forms.form.title') }}</h3>
                    <ul class="space-y-4">
                        @foreach (['item_1', 'item_2', 'item_3'] as $item)
                            <li class="flex items-center gap-3 text-gray-400">
                                ...
                                <span>{{ __('landing.why_not_forms.form.'.$item) }}</span>
                            </li>
                        @endforeach
                    </ul>
                </div>
            ...
            <div class="bg-gradient-to-br from-amber-50 to-orange-50 p-8 md:p-10 relative border-l-0 md:border-l border-gray-200">
                ...
                <div class="mt-14">
                    <h3 class="text-xl font-bold text-amber-700 mb-6">{{ __('landing.why_not_forms.assistant.title') }}</h3>
                    <ul class="space-y-4">
                        @foreach (['item_1', 'item_2', 'item_3'] as $item)
                            <li class="flex items-center gap-3 text-amber-800 font-medium">
                                ...
                                <span>{{ __('landing.why_not_forms.assistant.'.$item) }}</span>
                            </li>
                        @endforeach
                    </ul>
                </div>
